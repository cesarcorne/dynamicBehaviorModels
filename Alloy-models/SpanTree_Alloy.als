...
/*assert GoodSafety {
	all s : State | no r : s.runs | r in s.parent
}*/
...
assert Safety {
	--all s : State | no p1 : Process | p1 in ^(s.parent)[p1]
	 no p1 : Process | p1 in ^(so/last.parent)[p1]
}

check Safety for 5 but 5 State
check Safety for 5 but 10 State
check Safety for 5 but 15 State
check Safety for 5 but 20 State
check Safety for 5 but 25 State
check Safety for 5 but 30 State
check Safety for 5 but 40 State
check Safety for 5 but 50 State

check Safety for 8 but 5 State
check Safety for 8 but 10 State
check Safety for 8 but 15 State
check Safety for 8 but 20 State
check Safety for 8 but 25 State
check Safety for 8 but 30 State
check Safety for 8 but 40 State
check Safety for 8 but 50 State

check Safety for 10 but 5 State
check Safety for 10 but 10 State
check Safety for 10 but 15 State
check Safety for 10 but 20 State
check Safety for 10 but 25 State
check Safety for 10 but 30 State
check Safety for 10 but 40 State
check Safety for 10 but 50 State
